...
# max_seq_length = 256
# out_model_path = "gpt2-base"

# print('Load tokenizer')
# tokenizer = AutoTokenizer.from_pretrained("bencyc1129/gpt2-base")
...
print('Load tokenizer')
tokenizer = AutoTokenizer.from_pretrained("bencyc1129/gpt2-base", model_max_length=max_seq_length)
...
training_args = TrainingArguments(
        ...
        # gradient_accumulation_steps=3,  # accumulating the gradients before updating the weights
