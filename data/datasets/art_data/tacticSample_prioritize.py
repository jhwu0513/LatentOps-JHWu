...
def fetch_mitre():
    ...
    for tactic_id in tactics: 
        ...
        tactic_name = soup.html.h1.string.strip()
        tactic_object = {
        ...
        for technique in techniques: 
            ...
            if urlparse(technique_url).path.rstrip("/").split("/")[-1] not in technique_id:
                technique_id.append(urlparse(technique_url).path.rstrip("/").split("/")[-1])
        ...
        for i in technique_id:
            f.write(f"{i} {tactic_name}\n")
