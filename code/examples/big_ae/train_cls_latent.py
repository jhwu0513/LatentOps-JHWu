...
def main():
    ...
    for cls_step_single in cls_list:
        ...
        if not cls_step_single.isdigit():
            args.train_data_file = '../data/datasets/yelp_data/target_word/' + cls_step_single + '_train.txt'
            args.eval_data_file = '../data/datasets/yelp_data/target_word/' + cls_step_single + '_test.txt'
        classifier = DenseEmbedder(args.latent_size, 2, depth=4, num_classes=args.n_classes)
        classifier.to(args.device)
